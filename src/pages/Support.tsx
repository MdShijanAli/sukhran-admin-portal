...
const mockTickets: SupportTicket[] = [
  {
    ...
    description:
      "My order was supposed to be delivered this morning but I have not received it yet.",
  },
  {
    id: "2",
    ...
    description:
      "I tried to make a payment but it failed. However, the amount was deducted from my account.",
  },
  {
    id: "3",
    ...
    description:
      "The milk I received today was not fresh. The expiry date seems incorrect.",
  },
  {
    id: "4",
    ...
    assignedTo: "Support Agent 1",
    description:
      "I am unable to login to my account. The password reset link is not working.",
  },
  {
    id: "5",
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                  ...
                                  <Badge
                                    ...
                                    variant={
                                      statusConfig[ticket.status].variant
                                    }
                                  >
                                    <StatusIcon className="h-3 w-3" />
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    <SelectItem value="Support Agent 1">
                                      Support Agent 1
                                    </SelectItem>
                                    <SelectItem value="Support Agent 2">
                                      Support Agent 2
                                    </SelectItem>
                                    <SelectItem value="Support Agent 3">
                                      Support Agent 3
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
