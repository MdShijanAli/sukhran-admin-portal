...
const Brands = () => {
  ...
  const brandActions = useMemo<ActionItem<Brand>[]>(
    () => [
      {
    ...
    [t, hasPermission, handleViewDetails, handleEdit, handleDelete]
  );
  ...
  const columns = useMemo<Column<Brand>[]>(
    ...
    [t, store, brandActions, togglingBrandId, handleStatusToggle]
  );
